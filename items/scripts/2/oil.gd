...
var rarity = 2
const item_name = "Oil"
const item_description = "Step 2, cover your enemies in oil. When you hit an enemy, they are given the oil debuff. If they die, they have a 25% chance to explode."
const item_icon = preload("res://items/icons/oil.png")
var file_name = "res://items/scripts/2/oil.gd"
static var explosion_damage = 0.10
static var explosion_chance = 0.25
...
static func get_explosion_damage(enemy, percentage):
	return (enemy * percentage) + PlayerController.damage
