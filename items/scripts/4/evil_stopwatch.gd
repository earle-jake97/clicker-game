...
const item_description = "Every item that activates on a timer will activate an additional time. Any attacks per second items will have their effects doubled."
